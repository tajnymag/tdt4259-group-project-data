...
def scrape_production_consumption_detailed(from_date: datetime, to_date: datetime, output_file_path: str):
...
def main():
    print(f"Scraping production and consumption data from {START_DATE} to {END_DATE}")
